...
#include "I2S.h"
/*
 STM32F411VE Discovery CS43L22 Audio Code Connections 
...
void setup()
{
  ...
  Wire.stm32SetInstance(I2C1);
  Wire.stm32SetSDA(PB9);
  Wire.stm32SetSCL(PB6);
